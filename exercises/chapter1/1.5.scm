...
; evaluates (p) immediately, and that causes problems.  Since (p) calls itself,
; it will recurse and loop infinitely.
; Applicative-order evaluation will never evaluate (p), since the check for 
; (= x 0) will be true, and 0 will be returned.
